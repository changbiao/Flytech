...
- (BOOL)isSerialPortService {
    NSString *UUIDString = self.UUID.UUIDString;
    return [UUIDString isEqualToString:FTServiceUUIDStringConfiguration] || [UUIDString isEqualToString:FTServiceUUIDStringSerialPortOne] || [UUIDString isEqualToString:FTServiceUUIDStringSerialPortTwo] || [UUIDString isEqualToString:FTServiceUUIDStringSerialPortThree];
}
