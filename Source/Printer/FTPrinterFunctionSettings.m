...
@implementation FTPrinterFunctionSettings
...
+ (NSString *)stringForPeripheralDevice:(FTPrinterPeripheralDevice)peripheralDevice {
    switch (peripheralDevice) {
        case FTPrinterPeripheralDeviceDisabled: return @"Disabled"; break;
        case FTPrinterPeripheralDevicePesenterEnabled: return @"Presenter enabled"; break;
        case FTPrinterPeripheralDeviceDrawerEnabled: return @"Drawer enabled"; break;
        case FTPrinterPeripheralDeviceDrawerWinderEnabled: return @"Drawer/winder enabled"; break;
    }
}

+ (NSString *)stringForMarkSensor:(FTPrinterMarkSensor)markSensor {
    switch (markSensor) {
        case FTPrinterMarkSensorPaper: return @"Paper"; break;
        case FTPrinterMarkSensorOption: return @"Option"; break;
    }
}

+ (NSString *)stringForDivisionDriveMethod:(FTPrinterDivisionDriveMethod)divisionDriveMethod {
    switch (divisionDriveMethod) {
        case FTPrinterDivisionDriveMethodDynamic: return @"Dynamic"; break;
        case FTPrinterDivisionDriveMethodFixed: return @"Fixed"; break;
    }
}

+ (NSString *)stringForNumberOfDots:(FTPrinterNumberOfDots)numberOfDots {
    switch (numberOfDots) {
        case FTPrinterNumberOfDots72: return @"72"; break;
        case FTPrinterNumberOfDots144: return @"144"; break;
        case FTPrinterNumberOfDots288: return @"288"; break;
    }
}

+ (NSString *)stringForPrintSpeed:(FTPrinterPrintSpeed)printSpeed {
    switch (printSpeed) {
        case FTPrinterPrintSpeedNormal: return @"Normal"; break;
        case FTPrinterPrintSpeedHigh: return @"High"; break;
    }
}

+ (NSString *)stringForThermalPaper:(FTPrinterThermalPaper)thermalPaper {
    switch (thermalPaper) {
        case FTPrinterThermalPaperAF50KSE: return @"AF50KSE"; break;
        case FTPrinterThermalPaperAlpha90034: return @"Alpha90034"; break;
        case FTPrinterThermalPaperAP50KSD: return @"AP50KSD"; break;
        case FTPrinterThermalPaperAP50KSFZ: return @"AP50KSFZ"; break;
        case FTPrinterThermalPaperDTM9502: return @"DTM9502"; break;
        case FTPrinterThermalPaperF5041: return @"F5041"; break;
        case FTPrinterThermalPaperHW54E: return @"HW54E"; break;
        case FTPrinterThermalPaperKF50: return @"KF50"; break;
        case FTPrinterThermalPaperKIP370: return @"KIP370"; break;
        case FTPrinterThermalPaperKIP470: return @"KIP470"; break;
        case FTPrinterThermalPaperKPR440: return @"KPR440"; break;
        case FTPrinterThermalPaperKT55F20: return @"KT55F20"; break;
        case FTPrinterThermalPaperP220VBB1: return @"P220VBB1"; break;
        case FTPrinterThermalPaperP300: return @"P300"; break;
        case FTPrinterThermalPaperP350: return @"P350"; break;
        case FTPrinterThermalPaperP5045: return @"P5045"; break;
        case FTPrinterThermalPaperPD160R63: return @"PD160R63"; break;
        case FTPrinterThermalPaperPD160RN: return @"PD160RN"; break;
        case FTPrinterThermalPaperTF50KSE2D: return @"TF50KSE2D"; break;
        case FTPrinterThermalPaperTL69KSHW76B: return @"TL69KSHW76B"; break;
        case FTPrinterThermalPaperTP50KJR: return @"TP50KJR"; break;
        case FTPrinterThermalPaperTL69KSLH: return @"TL69KSLH"; break;
    }
}

+ (NSString *)stringForCharacterSetType:(FTPrinterCharacterSetType)characterSetType {
    switch (characterSetType) {
        case FTPrinterCharacterSetTypeBlankPage: return @"Blank page"; break;
        case FTPrinterCharacterSetTypeCodepage1252: return @"Codepage 1252"; break;
        case FTPrinterCharacterSetTypeExtendedGraphics: return @"Extended graphics"; break;
        case FTPrinterCharacterSetTypeKatakana1: return @"Katakana 1"; break;
        case FTPrinterCharacterSetTypeKatakana2: return @"Katakana 2"; break;
        case FTPrinterCharacterSetTypeUserPage: return @"User page"; break;
    }
}
...
- (instancetype)initWithData:(NSData *)data {
    self = [FTPrinterFunctionSettings validateDataForInitialization:data] ? [super init] : nil;
    if (self) {
...
- (FTPrinterCharacterSetType)characterSetType {
    switch (self.characterSet) {
        case 0: return FTPrinterCharacterSetTypeExtendedGraphics; break;
        case 1: return FTPrinterCharacterSetTypeKatakana1; break;
        case 16: return FTPrinterCharacterSetTypeCodepage1252; break;
        case 254: return FTPrinterCharacterSetTypeKatakana2; break;
        case 255: return FTPrinterCharacterSetTypeBlankPage; break;
        default: return FTPrinterCharacterSetTypeUserPage;
    }
}
...
- (void)setSWDIP2PropertiesAccordingToByte:(unsigned char)byte {
    ...
    switch (numberOfDots) {
        case 0x00: self.numberOfDots = FTPrinterNumberOfDots72; break;
        case 0x01: self.numberOfDots = FTPrinterNumberOfDots144; break;
        case 0x02: self.numberOfDots = FTPrinterNumberOfDots288; break;
        case 0x03: self.numberOfDots = FTPrinterNumberOfDots144; break;
    }
...
- (BOOL)isEqual:(id)object {
    ...
    FTPrinterFunctionSettings *other = object;
...
- (NSString *)descriptionForSWDIP4 {
    NSString *printingDensity = [NSString stringWithFormat:@"Printing density: %ld", self.printingDensity];
...
- (NSString *)descriptionForSWDIP6To7 {
    NSString *autoLoadingPaperFeedLength = [NSString stringWithFormat:@"Auto loading paper feed length: %ld", self.autoLoadingPaperFeedingLength];
    return [NSString stringWithFormat:@"SWDIP6 to 7 | %@", autoLoadingPaperFeedLength];
}

- (NSString *)descriptionForSWDIP8To9 {
    NSString *markPositionCorrection = [NSString stringWithFormat:@"Mark position correction: %ld", self.markPositionCorrection];
    return [NSString stringWithFormat:@"SWDIP8 to 9 | %@", markPositionCorrection];
}

- (NSString *)descriptionForSWDIP10To11 {
    NSString *markDetectionMaximumFeedingLength = [NSString stringWithFormat:@"Mark detection maximum feeding length: %ld", self.markDetectionMaximumFeedingLength];
    return [NSString stringWithFormat:@"SWDIP10 to 11 | %@", markDetectionMaximumFeedingLength];
}

- (NSString *)descriptionForSWDIP35 {
    NSString *characterSet = [NSString stringWithFormat:@"Character set: %ld (%@)", self.characterSet, [[self class] stringForCharacterSetType:self.characterSetType]];
