...
@interface ZBPrinterStatusUpdate ()

@property (copy, nonatomic) NSData *data;

@end

@implementation ZBPrinterStatusUpdate
...
+ (NSString *)stringForPaperFeedMotorDriveStatus:(ZBPrinterStatusPaperFeedMotorDrive)paperFeedMotorDriveStatus {
    switch (paperFeedMotorDriveStatus) {
        case ZBPrinterStatusPaperFeedMotorDriveStop: return @"Stop"; break;
        case ZBPrinterStatusPaperFeedMotorDriveWork: return @"Work"; break;
    }
}

+ (NSString *)stringForDrawerSensorStatus:(ZBPrinterStatusDrawerSensor)drawerSensorStatus {
    switch (drawerSensorStatus) {
        case ZBPrinterStatusDrawerSensorLow: return @"Low"; break;
        case ZBPrinterStatusDrawerSensorHigh: return @"High"; break;
    }
}
