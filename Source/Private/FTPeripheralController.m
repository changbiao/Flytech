...
- (void)peripheral:(CBPeripheral *)peripheral didDiscoverCharacteristicsForService:(CBService *)service error:(NSError *)error {
    NSLog(@"%@ %@, %@, %@", NSStringFromSelector(_cmd), peripheral, service, error);
...
- (void)peripheral:(CBPeripheral *)peripheral didDiscoverDescriptorsForCharacteristic:(CBCharacteristic *)characteristic error:(NSError *)error {
    NSLog(@"%@ %@, %@, %@", NSStringFromSelector(_cmd), peripheral, characteristic, error);
}
...
- (void)peripheral:(CBPeripheral *)peripheral didDiscoverServices:(NSError *)error {
    NSLog(@"%@ %@, %@", NSStringFromSelector(_cmd), peripheral, error);
...
- (void)peripheral:(CBPeripheral *)peripheral didModifyServices:(NSArray<CBService *> *)invalidatedServices {
    NSLog(@"%@ %@, %@", NSStringFromSelector(_cmd), peripheral, invalidatedServices);
}

- (void)peripheral:(CBPeripheral *)peripheral didReadRSSI:(NSNumber *)RSSI error:(NSError *)error {
    NSLog(@"%@ %@, %@, %@", NSStringFromSelector(_cmd), peripheral, RSSI, error);
}
...
- (void)peripheral:(CBPeripheral *)peripheral didUpdateValueForDescriptor:(CBDescriptor *)descriptor error:(NSError *)error {
    NSLog(@"%@ %@, %@, %@", NSStringFromSelector(_cmd), peripheral, descriptor, error);
}
...
- (void)peripheralDidUpdateName:(CBPeripheral *)peripheral {
    NSLog(@"%@ %@", NSStringFromSelector(_cmd), peripheral);
}
